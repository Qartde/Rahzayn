...
const fetchGitHubRepoDetails = async () => {
  try {
    const _0x1c6838 = await axios.get("https://api.github.com/repos/deshallos1/Rahzayn");
    const {
      name: _0x4ae93b,
      ...
      await _0x23108e.sendMessage(_0x3247d3, {
        ...
        'contextInfo': {
          'externalAdReply': {
            ...
            'mediaUrl': "h       'sourceUrl': "https://chat.whatsapp.com/DTnrZzULVtP5r0E9rhoFOj"
          }
        }
      });
    } catch (_0x2ec752) {
